    ...
    <div className="flex h-full flex-col overflow-y-auto scroll-slim">
      ...
      <div className="mx-auto w-full max-w-2xl p-5 sm:p-8">
        ...
        <div className="flex items-start justify-between gap-3">
          <h1 className="font-display text-2xl font-bold leading-snug">{kajian.title}</h1>
          {isToday && <Badge variant="today" className="shrink-0">Hari ini</Badge>}
        </div>
        ...
        <p className="mt-5 leading-relaxed text-foreground/90">{kajian.description}</p>
