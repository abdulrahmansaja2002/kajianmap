...
export function KajianDetailDrawer({
  ...
  return (
    <Drawer open={open} onOpenChange={onOpenChange}>
      {/* 1. Kunci Drawer menjadi Flex Container bertinggi maks 85vh */}
      <DrawerContent className="mx-auto flex max-h-[85vh] w-full max-w-2xl flex-col overflow-hidden">
        
        {/* 2. Header dibuat Fixed (shrink-0) agar tidak ikut tergulung */}
        ...
        {/* 3. Pindahkan overflow-y-auto ke div internal ini & tambahkan pb-14/pb-16 */}
        <div className="scroll-slim flex-1 overflow-y-auto p-5 pb-16">
